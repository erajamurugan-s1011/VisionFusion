...
# Auto-trust torch.hub repos (needed for MiDaS's internal dependency
# fetch of rwightman/gen-efficientnet-pytorch) — this runs non-interactively
# in Docker, so we can't respond to the y/N prompt manually.
...
def compute_severity(depth_map, bbox_xyxy, frame_shape):
    ...
    size_factor = min(bbox_area_frac * 20, 1.0)
